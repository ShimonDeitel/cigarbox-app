...
struct ContentView: View {
    ...
    @State private var editingEntry: CigarEntry?
...
struct EntryRow: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 4) {
            ...
            Text("Brand: \(entry.brand)  ·  Size: \(entry.size)")
                .font(.caption)
...
struct EntryFormView: View {
    ...
    init(mode: FormMode) {
        ...
        if case .edit(let entry) = mode {
            ...
            _f1 = State(initialValue: entry.brand)
            _f2 = State(initialValue: entry.size)
        ...
        NavigationStack {
            Form {
                Section("Details") {
                    ...
                    TextField("Brand", text: $f1)
                        .accessibilityIdentifier("f1Field")
                    TextField("Size", text: $f2)
